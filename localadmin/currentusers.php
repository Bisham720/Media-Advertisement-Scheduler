...
<ul class="nav nav-tabs">
  <li class="nav-item">
    <a class="nav-link active" href="currentusers.php">Current User</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="index.php">Pending Requests</a>
  </li>
</ul>
<br>
...
<?php
  $sql = "SELECT * FROM tbl_registration where u_status = 'approved'";
...
?>    
 <tbody>
    <tr>
      ...
      <td><a href="currentdetailsusers.php?id=<?php echo $row['u_id'];?>"><button type="button" class="btn btn-primary">View Details</button></a></td>
    </tr>
  </tbody>
<?php
    }
